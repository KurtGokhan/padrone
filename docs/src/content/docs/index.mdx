...
<CardGrid stagger>
  ...
  <Card title="Interceptors & Extensions" icon="setting">
    Middleware-style interceptors intercept parse, validate, and execute phases with an onion model. Extensions provide build-time composition.
  </Card>
